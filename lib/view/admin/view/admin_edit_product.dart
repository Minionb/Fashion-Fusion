...
class AdminEditProductScreen extends StatefulWidget {
  ...
  const AdminEditProductScreen({super.key, required this.model});
...
class _AdminEditProductScreenState extends State<AdminEditProductScreen> {
  ...
  void initState() {
    ...
    productDescriptionController.text = widget.model.productDescription ?? "";
    priceController.text = (widget.model.price ?? 0).toString();
    quantityController.text = (widget.model.soldQuantity).toString();
    List<String> hashtagsList = widget.model.tags
            ?.split(',')
    ...
    categories = widget.model.category?.split(', ') ?? [];
  }
                        ...
                        onPressed: () {
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            context
                                ...
                                .updateProduct(model, widget.model.id ?? "");
                          }
                        },
